    ...
    $.ajax({
            ...
            success: function (data) {
                ...
                <tr id="post_id_${data.id}">
                 ...
                 <td>${data.body}</td>
                 <td>
                    <a href="javascript:void(0)" id="edit-post" data-id="${data.id}" class="btn btn-info">Edit</a>
                </td>
                 <td>
                  <a href="javascript:void(0)" id="delete-post" data-id="${data.id}" class="btn btn-danger delete-post">Delete</a>
                </td>
              </tr>
                    `);
                    });
